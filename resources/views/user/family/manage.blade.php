<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <span class="{{ $familyInfo->verified ? 'text-green-500' : 'text-red-500' }}">
        ...
        <form method="POST" action="{{ route('user.family.update') }}" class="space-y-8">
            ...
            <div class="border border-gray-200 p-4 rounded-lg">
                ...
                <textarea name="additional_info" id="additional_info" rows="4"
                          class="form-textarea rounded-md shadow-sm mt-2 block w-full">{{ old('additional_info', $familyInfo->additional_info) }}</textarea>
            </div>
